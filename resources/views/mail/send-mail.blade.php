<div data-v-5a45470d="" class="sticky top-5" style="display: flex; flex-direction: column; gap: 20px;">
    <div data-v-5a45470d="" class="preview-content" style="border-radius: 3px;">
        <img data-v-5a45470d="" src="blob:http://localhost:8080/170706eb-5377-4288-bc74-24bd121f16ba" alt=""
             style="width: 100%; object-fit: cover;">
        <div data-v-5a45470d="" class="preview-email-content"
             style="background: rgb(188, 41, 41); padding: 28px 30px 36px; display: flex; flex-direction: column; gap: 30px; border-radius: 3px; color: rgb(255, 255, 255);">
            <div data-v-5a45470d="" class="email--content" style="line-break: anywhere;">
                <p>hello
                    <span style="background:#003084;padding:2px;border-radius:4px;color: #ffffff"
                          id="Shop_name">Shop_name</span>
                </p>
            </div>
